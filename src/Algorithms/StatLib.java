...
public class StatLib {
	...
	// method that calculates the avg
	...
	// performs a linear regression and returns the totalFlightTime equation
	...
	// returns the deviation between point p and the totalFlightTime equation of the points
	...
	// returns the deviation between point p and the totalFlightTime
